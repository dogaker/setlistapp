...
#    print len(grouped_df_full)
    ...
    songspredicted = [col for col in list(
        songspredicted) if col.startswith('song_')]
    ...
    if songspredicted:
        ...
        songspredicted['predictedsongs'] = songspredicted[
            'predictedsongs'].str.replace('song_', '')
#        songspredicted['predictedsongs'] = songspredicted['predictedsongs'].str.replace('_', ' ').str.title()
        return songspredicted, roc_score, hashnames, predictions
    else:
